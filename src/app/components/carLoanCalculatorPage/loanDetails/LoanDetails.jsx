...
const LoanDetails = () => {
  ...
  return (
    <>
      <div className="my-2 p-4 bg-slate-200  rounded-lg sm:flex justify justify-between">
        <div className="flex">
          <Image
            ...
            <div className="sm:col-span-6 sm:block">
              ...
              <div className="flex justify-between w-full my-4">
                <div className="flex justify-between">
                  ...
                  <span id="price" className="mx-2 font-semibold">
                    AED {emi.toFixed(2).toLocaleString("en-US")}*
                  </span>
                </div>
                <div className="flex justify-between">
                  <p className="opacity-70 mt-0 ">Total Interest</p>
                  <span id="ci" className="mx-2  font-semibold opacity-100">
